...
import maleIcon from "../resource/vstyle/male.svg";
import femaleIcon from "../resource/vstyle/female.svg";
import tankTopIcon from "../resource/vstyle/tanktop.svg";
import tShirtIcon from "../resource/vstyle/tshirt.svg";
import shirtIcon from "../resource/vstyle/shirt.svg";
import sweaterIcon from "../resource/vstyle/sweater.svg";
import suitIcon from "../resource/vstyle/suit.svg";
import outwearIcon from "../resource/vstyle/outerwear.svg";
import dressIcon from "../resource/vstyle/dress.svg";
import solidIcon from "../resource/vstyle/solid.svg";
import graphicIcon from "../resource/vstyle/graphics.svg";
import floralIcon from "../resource/vstyle/floral.svg";
import plaidIcon from "../resource/vstyle/plaid.svg";
import spottedIcon from "../resource/vstyle/spotted.svg";
import stripedIcon from "../resource/vstyle/striped.svg";
import foldedIcon from "../resource/vstyle/folded.svg";
import roundIcon from "../resource/vstyle/round.svg";
import vshapeIcon from "../resource/vstyle/vshape.svg";
import hatIcon from "../resource/vstyle/hat.svg";
import glassesIcon from "../resource/vstyle/glasses.svg";
import scarfIcon from "../resource/vstyle/scarf.svg";
import tieIcon from "../resource/vstyle/necktie.svg";
...
export default function VstyleFunComponent(props) {
    ...
    useEffect(() => {
        ...
        glyph.append("div").attr("class", "clothing");
        glyph.append("div").attr("class", "neckline");
        glyph.append("div").attr("class", "accessory-hat");
        glyph.append("div").attr("class", "accessory-glasses");
        glyph.append("div").attr("class", "accessory-necktie");
        glyph.append("div").attr("class", "accessory-scarf");
        glyph.append("div").attr("class", "patterns");
        d3.select(".patterns").html(() => {
            return graphicsPatternHTML + floralPatternHTML + spottedPatternHTML + stripedPatternHTML + plaidPatternHTML + colorfulPatternHTML;
        });
    },[]);
    ...
    useEffect(() => {
        ...
        d3.select(".downbody").html(() => {
            if (activeGender === 0) {
                if (activeClothingCategory === 6) {
        ...
        d3.select(".clothing").html(() => {
           if (activeClothingCategory === 0) {
               d3.select(".clothing").attr("class", "clothing tanktop-position");
               return tanktopHTML;
           } else if (activeClothingCategory === 1) {
               d3.select(".clothing").attr("class", "clothing tshirt-position");
               return tshirtHTML;
           } else if (activeClothingCategory === 2) {
               d3.select(".clothing").attr("class", "clothing shirt-position");
               return shirtHTML;
           } else if (activeClothingCategory === 3) {
               d3.select(".clothing").attr("class", "clothing sweater-position");
               return sweaterHTML;
           } else if (activeClothingCategory === 4) {
               d3.select(".clothing").attr("class", "clothing suit-position");
               return suitHTML;
           } else if (activeClothingCategory === 5) {
               d3.select(".clothing").attr("class", "clothing outerwear-position");
               return outerwearHTML;
           } else {
               d3.select(".clothing").attr("class", "clothing dress-position");
               return dressHTML;
           }
        });

        d3.select(".clothing svg").attr("fill", () => {
            if (activeClothingPattern === 0) {
                return "none";
            } else if (activeClothingPattern === 1) {
                return "url(#graphicsPattern)";
            } else if (activeClothingPattern === 2) {
                return "url(#floralPattern)";
            } else if (activeClothingPattern === 3) {
                return "url(#plaidPattern)";
            } else if (activeClothingPattern === 4) {
        ...
        d3.select(".neckline").html(() => {
            if (activeNecklineShape === 0) {
                d3.select(".neckline").attr("class", "neckline folded-position");
                return foldedHTML;
            } else if (activeNecklineShape === 1) {
                d3.select(".neckline").attr("class", "neckline round-position");
                return roundHTML;
            } else {
                d3.select(".neckline").attr("class", "neckline vshape-position");
                return vshapeHTML;
            }
        });

        d3.selectAll(".part1").style("fill", () => {
            if (activeSkinColor === 0) {
                return "#ddbe9a";
            } else if (activeSkinColor === 1) {
                return "#d3ab84";
            } else {
                return "#926b45";
            }
        ...
        d3.select(".left").style("fill", () => {
            if (activeClothingColor === 0) {
                return colorsLeft.Black;
            } else if (activeClothingColor === 1) {
                return colorsLeft.White;
            } else if (activeClothingColor === 2) {
                return colorsLeft.Pink;
            } else if (activeClothingColor === 3) {
                return colorsLeft.Blue;
            } else if (activeClothingColor === 4) {
                return colorsLeft.Red;
            } else if (activeClothingColor === 5) {
                return colorsLeft.Cyan;
            } else if (activeClothingColor === 6) {
                return colorsLeft.Green;
            } else if (activeClothingColor === 7) {
                return colorsLeft.Gray;
            } else if (activeClothingColor === 8) {
                return colorsLeft.Yellow;
            } else if (activeClothingColor === 9) {
                return colorsLeft.Brown;
            } else if (activeClothingColor === 10) {
                return colorsLeft.Purple;
            } else if (activeClothingColor === 11) {
                return colorsLeft.Orange;
            } else {
                return colorsLeft.Colorful;
            }
        });

        d3.selectAll(".right").style("fill", () => {
            if (activeClothingColor === 0) {
                return colorsRight.Black;
            } else if (activeClothingColor === 1) {
                return colorsRight.White;
            } else if (activeClothingColor === 2) {
                return colorsRight.Pink;
            } else if (activeClothingColor === 3) {
                return colorsRight.Blue;
            } else if (activeClothingColor === 4) {
                return colorsRight.Red;
            } else if (activeClothingColor === 5) {
                return colorsRight.Cyan;
            } else if (activeClothingColor === 6) {
                return colorsRight.Green;
            } else if (activeClothingColor === 7) {
                return colorsRight.Gray;
            } else if (activeClothingColor === 8) {
                return colorsRight.Yellow;
            } else if (activeClothingColor === 9) {
                return colorsRight.Brown;
            } else if (activeClothingColor === 10) {
                return colorsRight.Purple;
            } else if (activeClothingColor === 11) {
                return colorsRight.Orange;
            } else {
                return colorsRight.Colorful;
            }
        });

        d3.select(".accessory-hat").html(() => {
            if (activeGender === 0) {
                d3.select(".accessory-hat").attr("class", "accessory-hat malehat-position");
                return maleHatHTML;
            } else {
                d3.select(".accessory-hat").attr("class", "accessory-hat femalehat-position");
                return femaleHatHTML;
            }
        }).style("opacity", () => {
            if (activeAccessory[0] === true) {
                return "1";
            } else {
                return "0";
            }
        ...
        d3.select(".accessory-glasses").html(() => {
            if (activeGender === 0) {
                d3.select(".accessory-glasses").attr("class", "accessory-glasses maleglasses-position");
                return maleGlassesHTML;
            } else {
                d3.select(".accessory-glasses").attr("class", "accessory-glasses femaleglasses-position");
                return femaleGlassesHTML;
            }
        }).style("opacity", () => {
            if (activeAccessory[1] === true) {
                return "1";
            } else {
                return "0";
            }
        ...
        d3.select(".accessory-scarf").html(() => {
            d3.select(".accessory-scarf").attr("class", "accessory-scarf scarf-position");
            return scarfHTML;
        }).style("opacity", () => {
            if (activeAccessory[2] === true) {
                return "1";
            } else {
                return "0";
            }
        ...
        d3.select(".accessory-necktie").html(() => {
            d3.select(".accessory-necktie").attr("class", "accessory-necktie necktie-position");
            return necktieHTML;
        }).style("opacity", () => {
            if (activeAccessory[3] === true) {
                return "1";
            } else {
                return "0";
            }
        ...
        const glyphData = [
            ...
            {
                component: ".downbody",
                element: ".downbody svg",
            },
            {
                component: ".clothing",
                element: ".clothing svg",
            },
            {
                component: ".neckline",
                element: ".neckline svg",
            },
            {
                component: ".accessory-hat",
                element: ".accessory-hat svg",
            },
            {
                component: ".accessory-glasses",
                element: ".accessory-glasses svg",
            },
            {
                component: ".accessory-scarf",
                element: ".accessory-scarf svg",
            },
            {
                component: ".accessory-necktie",
                element: ".accessory-necktie svg",
            },
        ];

        const newGlyhDATA = glyphData.map((obj) => {
            const elementSize = d3.select(obj.element).node().getBBox();
            const componentSize = d3.select(obj.component).selectAll("*").node().getBBox();
        ...
        for(let i = 0; i < newGlyhDATA.length; i++) {
            d3.selectAll(newGlyhDATA[i].element).attr("width", newGlyhDATA[i].elementSize.width * 1.1)
                .attr("height", newGlyhDATA[i].elementSize.height * 1.1)
                .attr("viewBox", "0 0 " + newGlyhDATA[i].elementSize.width + " " + newGlyhDATA[i].elementSize.height);

            d3.selectAll(newGlyhDATA[i].component).style("width", newGlyhDATA[i].componentSize.width * 1.1 + "px")
                .style("height", newGlyhDATA[i].componentSize.height * 1.1 + "px");
        }

    }, [activeGender, activeSkinColor, activeClothingCategory, activeClothingPattern, activeNecklineShape, activeAccessory, activeClothingColor]);
    ...
    return (
        <Row>
          ...
          <Col md={4} style={{paddingTop: "6.8rem"}}>
